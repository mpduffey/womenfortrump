...
@NgModule({
  ...
  exports:      [NavMenu, SpsIntroSection, SpsAboutSection, SpsEventCalendar, SpsMembership, SpsFooter, EventForm, Modal, ReactiveForm, ReactiveFormInput, SinglePageScrolling, SpsContactSection, ImgGallery, Filter],
  declarations: [AppComponent, NavMenu, SpsIntroSection, SpsAboutSection, SpsEventCalendar, SpsMembership, SpsFooter, EventForm, Modal, ReactiveForm, ReactiveFormInput, SinglePageScrolling, SpsContactSection, ImgGallery, Filter],
